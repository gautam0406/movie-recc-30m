...
def get_recommendations_CF(title: str, selected_model):
    ...
    similarity_matrix = selected_model["similarity_matrix"]
    movies_df = selected_model["movies_df"]

    movie_id = movies_df[movies_df['title'] == title]['id'].values
    ...
    # recommended_movies = top_similar_movies.index.tolist()
    recommended_movies = movies_df[movies_df['id'].isin(top_similar_movies.index)]['title'].tolist()
